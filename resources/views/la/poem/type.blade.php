...
@section("contentheader_title", "类型")
@section("contentheader_description", "类型 listing")
@section("section", "类型")
@section("sub_section", "Listing")
@section("htmlheader_title", "类型 Listing")
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">创建古诗类型</h4>
                </div>
                {{--<div class="modal-body">--}}
                {{--请填写以下信息<span id="span-title"></span>--}}
                {{--</div>--}}
                <div class="modal-footer">
                    <form action="{{ url('/admin/poem/type/save') }}" id="delete-form" method="post">
                        {{ csrf_field() }}
    ...
    <script>
        $(function () {
            $("#example1").DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ url(config('laraadmin.adminRoute') . '/poem_type_ajax') }}",
                language: {
                    lengthMenu: "_MENU_",
                    search: "_INPUT_",
