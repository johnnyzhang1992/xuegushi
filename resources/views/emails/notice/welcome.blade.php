            ...
            <tr>
                <td colspan="3" style="height:50px;line-height:50px;text-align:center;">
                    <a href="{{ url('/') }}" target="_blank" style="display:block;height:50px;width:100%;text-decoration:none;font-size:16px;color:#222222;vertical-align:top;" draggable="false">
                        <span style="line-height:50px;vertical-align:top;display:inline-block;font-family:Microsoft YaHei,Simsun;font-size:16px;">7 万+古诗文供您学习</span></a>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3" style="border-bottom:1px solid #dcdcdc;">
                    <table style="font-family:Microsoft YaHei,Simsun;width:100%;max-width:650px;_width:650px;*width:650px;table-layout:fixed;text-align:center;margin:10px 0" bgcolor="#ffffff" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                                <div class="mail_msg padding-60" style="text-align: left;">
                                    <p style="line-height: 32px">你好，{{ @$user_name }}。</p>
                                    <p style="line-height: 32px">您收到此邮件，说明您已经注册成功，成为了我们古诗文学习大军中的一员。我们一起加油吧！</p>
                                    <p style="line-height: 32px">你的登录邮箱为：{{ @$email }}。请您记住此邮箱,以后将作为您登录以及找回密码的凭证。</p>
                                    <p style="line-height: 32px">下面就开始你的学习之旅吧!  <a href="{{ url('/') }}">点我开始</a></p>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p class="padding-60" style="text-align: left;">
