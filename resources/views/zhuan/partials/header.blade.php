    ...
    <div class="col-md-9 col-xs-12">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                @else
                    <li class="write"><a href="{{ url(Auth::user()->domain && strlen(Auth::user()->domain)>0 ? 'people/'.Auth::user()->domain : 'people/'.Auth::user()->id ) }}">我的主页</a></li>
                    @if(isset($is_has) && $is_has)
                    @else
