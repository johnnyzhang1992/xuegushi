                    ...
                    @if(isset($zhuans) && $zhuans)
                        @foreach($zhuans as $zhuan)
                            <li class="col-md-3 col-xs-12">
                                ...
                                <p class="HomeColumn-title"><a target="_blank" href="/jimmychow">{{ @$zhuan->alia_name }}</a></p>
                                <p class="HomeColumn-description"><a target="_blank" href="/jimmychow">{{ @$zhuan->about }}</a></p>
